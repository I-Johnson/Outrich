...
CASES = [
 ...
 ('thread-b-schedule','What are the delivery schedules?','alert','schedule unknown'),
 ...
 ('thread-b-five','Need five loads a day','alert','capacity commitment'),
 ('thread-b-hook','Hook and drop empty back','alert','equipment/service terms'),
 ('thread-b-monday','Pickup Monday, return Monday','alert','schedule terms'),
 ...
 ('thread-c-commodity','Thirty pallets of manufactured components.','alert','commodity only'),
 ('thread-c-book','Let us book it please','alert','booking intent'),
 ('thread-c-capacity','Our carrier-setup department is reviewing the packet.','alert','carrier onboarding'),
 ('thread-c-highway','Carrier verification portal is complete.','alert','onboarding'),
 ('thread-c-driver','Please send driver details and arrival time.','alert','driver info'),
 ('thread-c-pu','Has the driver checked in at pickup?','alert','post-book tracking'),
 ('thread-c-loaded','Tell us when the trailer is loaded.','alert','post-book tracking'),
 ('thread-c-eta','What is the estimated delivery arrival?','alert','post-book tracking'),
