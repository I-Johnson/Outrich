(() => {
  const help = {
    ...
    mc_number: "The carrier's Motor Carrier number used in inquiries and permitted broker replies.",
    dot_number: "The carrier's USDOT identifier, shared only when the profile allows it.",
